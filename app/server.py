...
APP_VERSION = "4.2 PHKS Cloud Test + Diverse Deep Analysis"
    ...
    for h in houses:
        ...
        for p in occ:
            ...
            if p['key'] in {'Saturn','Mars','Rahu','Ketu'}:
                pressure_map={
                    'Saturn':{
                        1:'තමන් ගැන සැකය, බරපතළ වගකීම් හෝ මන්දගාමී ආරම්භයක්', 2:'මුදල් රඳවා ගැනීමට අපහසුකම්, පවුල් වගකීම් හෝ කථනයේ දැඩිභාවය',
                        3:'උත්සාහයේ මන්දගාමී ප්‍රගතිය, සහෝදර සම්බන්ධතා දුරස්වීම හෝ දිගුකාලීන මහන්සිය', 4:'නිවස/දේපළ/මව්පාර්ශවය සම්බන්ධ බරපතළ වගකීම් හෝ සැනසීම අඩුවීම',
                        5:'අධ්‍යාපනය, ආදරය හෝ දරුවන් සම්බන්ධ ප්‍රතිඵල පරිණත වීමට කාලය ගතවීම', 6:'දෛනික වැඩ බර, සේවා වගකීම් හෝ දිගුකාලීන තරඟකාරී පීඩනය',
                        7:'සබඳතාවයේ දුරස්වීම, වගකීම් වැඩි වීම හෝ බැඳීම සම්බන්ධ බරපතළ තීරණ', 8:'අභ්‍යන්තර බිය, දීර්ඝකාලීන පරිවර්තන හෝ හවුල් සම්පත් බර',
                        9:'උසස් අධ්‍යාපනය/දුර ගමන්/ගුරු සම්බන්ධතා මන්දගාමීව ඉදිරියට යාම', 10:'වෘත්තීය බර, දැඩි වගකීම් සහ ප්‍රතිඵල සඳහා දිගුකාලීන කැපවීම',
                        11:'ලාභ මන්දගාමීව ගොඩනැගීම, මිතුරු ජාලයේ තේරීම් හෝ අරමුණු සඳහා දිගුකාලීන සැලසුම', 12:'විදේශ/වියදම්/නිශ්ශබ්දතාව සම්බන්ධ බර, තනිව වැඩ කිරීම හෝ සීමාකරණය'},
                    'Mars':{
                        1:'ඉක්මන් තීරණ, කෝපය හෝ අනතුරුදායක අවධානම් ගැනීම', 2:'මුදල්/පවුල්/කථනයේ ආවේගශීලී ප්‍රතිචාර', 3:'තරඟකාරීත්වය, සහෝදරයන් සමඟ ගැටුම් හෝ අධික අවදානම්',
                        4:'නිවසේ උණුසුම් වාතාවරණය, දේපළ/වාහන තීරණවල ඉක්මන්භාවය', 5:'ආදරය/දරුවන්/අධ්‍යාපනයේ ඉක්මන් ප්‍රතිචාර සහ තරඟකාරී ආකල්ප',
                        6:'ගැටුම්, වැඩබිමේ තරඟ, ශාරීරික අධික වෙහෙස හෝ හදිසි ක්‍රියා', 7:'සබඳතාවල උණුසුම් වාද, ඉක්මන් තීරණ හෝ බල තරඟ', 8:'හදිසි වෙනස්කම්, අවදානම්, රහස් ගැටුම් හෝ ශල්‍ය/අනතුරු සංකේත',
                        9:'විශ්වාස/අධ්‍යාපන අදහස් ගැන දැඩි මතභේද හෝ ඉක්මන් දුර ගමන්', 10:'වෘත්තීය තරඟකාරීත්වය, අධික ක්‍රියාශීලීත්වය හෝ අධිකාරීන් සමඟ ගැටුම්',
                        11:'ලාභ සඳහා දැඩි තරඟය, මිතුරු ජාලයේ ගැටුම් හෝ ඉක්මන් ව්‍යාපාර තීරණ', 12:'සැඟවුණු කෝපය, අනපේක්ෂිත වියදම් හෝ විදේශයේ ආවේගශීලී තීරණ'},
                    'Rahu':{
                        1:'අනන්‍යතාව ගැන අතිශය ආශාව, අසාමාන්‍ය තීරණ හෝ පෙනුම/ප්‍රතිරූපය ගැන අධික අවධානය', 2:'අසාමාන්‍ය ආදායම් මාර්ග, වචනයේ අතිශයෝක්තිය හෝ මුදල් අවදානම්',
                        3:'ඩිජිටල්/මාධ්‍ය/වෙළඳ කටයුතුවල අතිශය උත්සාහය, නමුත් අසම්මත අවදානම්', 4:'නිවස/පදිංචිය සම්බන්ධ අස්ථාවරත්වය හෝ විදේශීය පරිසරයට ආකර්ෂණය',
                        5:'අසාමාන්‍ය ආදර/අධ්‍යාපන/නිර්මාණ රටා, speculation ගැන අවදානම', 6:'තරඟකරුවන් මත ජයගැනීමට දැඩි ආශාව, නමුත් වැඩ/ණය/ලේඛනවල සංකීර්ණතා',
                        7:'අසාමාන්‍ය සබඳතා, විදේශීය හවුල්කාරීත්වය හෝ පැහැදිලි නොවන ගිවිසුම්', 8:'රහස්, හදිසි පරිවර්තන, බදු/හවුල් සම්පත් හෝ ගැඹුරු මානසික අවුල්',
                        9:'විදේශ/උසස් අධ්‍යාපනයේ අසාමාන්‍ය මාර්ග, ගුරු/විශ්වාස ගැන ප්‍රශ්න කිරීම', 10:'අසාමාන්‍ය වෘත්තීය උසස්වීම්, ප්‍රසිද්ධියට දැඩි ආශාව හෝ නීතිමය/ප්‍රතිරූප අවදානම්',
                        11:'විශාල ජාල, අසාමාන්‍ය ලාභ අවස්ථා, නමුත් අධික බලාපොරොත්තු', 12:'විදේශ, රහසිගත වියදම්, නින්ද/මනස අවුල් හෝ පලායාමේ ආශාව'},
                    'Ketu':{
                        1:'තමන්ගෙන් වෙන්වී සිටින හැඟීම, අභ්‍යන්තර සෙවීම හෝ හදිසි දිශාමාරු', 2:'පවුල්/මුදල් ගැන වෙන්වීම, අඩු කථනය හෝ ඉතිරි කිරීමේ රටාව වෙනස් වීම',
                        3:'සහෝදර/සන්නිවේදන අංශයේ දුරස්වීම, නමුත් ගැඹුරු තාක්ෂණික/අභ්‍යන්තර කුසලතා', 4:'නිවසේ සැනසීමෙන් වෙන්වීම, පදිංචි වෙනස්කම් හෝ අභ්‍යන්තර නිශ්ශබ්දතාව',
                        5:'ආදරය/දරුවන්/අධ්‍යාපනයේ අසම්මත රටා, තද අභ්‍යන්තර අවධානය', 6:'සතුරන්/බාධා කපාහැරීමට හැකියාව, නමුත් දෛනික රටාවෙන් වෙන්වීම',
                        7:'සබඳතාවල දුරස්වීම, අතිශය ස්වාධීනත්වය හෝ බැඳීම ගැන අභ්‍යන්තර සැක', 8:'ගැඹුරු පරිවර්තනය, රහස්/අධ්‍යාත්මික කරුණු හෝ හදිසි වෙන්වීම්',
                        9:'සාම්ප්‍රදායික විශ්වාසවලින් වෙන්වීම, ගැඹුරු ආධ්‍යාත්මික සෙවීම හෝ ගුරු මාරු', 10:'වෘත්තීය තෘප්තිය අඩුවීම, මාර්ගය මාරු කිරීමට ආශාව හෝ පසුබිම් වැඩ',
                        11:'මිතුරු ජාලයෙන් තේරීම්, ලාභයෙන් වෙන්වීම හෝ අරමුණු නැවත අර්ථ දක්වීම', 12:'භාවනා, තනිවීම, විදේශ/ආධ්‍යාත්මික රටා, නමුත් ලෝකික කටයුතුවලින් වෙන්වීම'}
                }
                phrase=pressure_map.get(p['key'],{}).get(h,'තදබල වෙනස්කම් හෝ වැඩි අවධානයක් අවශ්‍ය වන රටාවක්')
                cautions.append(f"{h} වන භාවයේ {p['name']} සිටීම නිසා {phrase} පෙනිය හැක")
...
def expanded_reading(lagna, planets, dasha, reference=False):
    ...
    for idx,(title,houses,focus) in enumerate(section_specs):
        ...
        if caution:
            ...
            experience_bank=[
              ['තීරණ ගැනීමේ විශ්වාසය වෙනස් වීම','තමන්ගේ දිශාව නැවත සකස් කිරීම','වගකීම් භාරගැනීමෙන් පරිණත වීම'],
              ['මනස ඉක්මනින් උණුසුම් වීම','එකම කරුණ නැවත නැවත සිතීම','පවුල් වාතාවරණයට වැඩි සංවේදීතාව'],
              ['ආදායම් රටාව උච්ච-පහළ වීම','ඉතිරි කිරීමේ රටාව වෙනස් වීම','පවුල් වියදම්වලට ප්‍රමුඛතාව දීමට සිදුවීම'],
              ['අධ්‍යාපන මාර්ග මාරු වීම','අසම්මත විෂය/තාක්ෂණික කුසලතාවකට හැරීම','විභාගයට වඩා ප්‍රායෝගික දැනුමෙන් ඉදිරියට යාම'],
              ['රැකියා භූමිකාව හදිසියේ වෙනස් වීම','අධිකාරීන් සමඟ මතභේද','ස්වයං රැකියාව හෝ වෙනත් වෘත්තීය මාර්ගයක් සලකා බැලීම'],
              ['හවුල්කාරීත්වයේ බල තරඟ','ගිවිසුම්වල සැඟවුණු කොන්දේසි','තනිව වැඩ කිරීම වඩා පහසු යැයි හැඟීම'],
              ['සබඳතාවයේ දුරස්වීම හෝ අධික ඇලීම','වැරදි අවබෝධ','බැඳීමේ ආකාරය නැවත සලකා බැලීම'],
              ['විදේශ අවස්ථාවක් හදිසියේ පැමිණීම','ගමන් සැලැස්ම වෙනස් වීම','පදිංචි මාරුවක් හෝ දුරස්ථ ජීවිත රටාවක්'],
              ['නිවසේ පරිසරය වෙනස් කිරීම','දේපළ/වාහන ගැන හදිසි තීරණ','පවුල් වගකීම් නිසා පදිංචි සැලැස්ම වෙනස් වීම'],
              ['දරුවන්/ආදරය/නිර්මාණශීලීත්වයේ අසම්මත රටා','අධ්‍යාපන ආකාරය වෙනස් කිරීම','ඉතා ගැඹුරු එකම කුසලතාවකට අවධානය යොමු කිරීම'],
              ['ණය හෝ වියදම් පාලනය නැවත සකස් කිරීම','හදිසි ජීවිත මාරුවක්','අභ්‍යන්තර පීඩනයෙන් පසු නව ආරම්භයක්'],
              ['සමාජ ජාලය වෙනස් වීම','කීර්තිය හදිසියේ වැඩි හෝ අඩු වීම','අරමුණු තේරීම් කරමින් වඩා සීමිත ජාලයක් ගොඩනැගීම']
            ]
            opts=experience_bank[idx]
            chosen=[opts[(seed+idx)%len(opts)], opts[(seed+idx+1)%len(opts)]]
            body += ' ඇතිවිය හැකි අත්දැකීම්: ' + '; '.join(chosen) + '. මේවා නියත සිදුවීම් නොව, අදාළ දශා/ගෝචර සක්‍රීය කාලවල වැඩිපුර පෙනිය හැකි සාම්ප්‍රදායික ජ්‍යෝතිෂ්‍ය ප්‍රවණතා ලෙස සලකන්න.'
